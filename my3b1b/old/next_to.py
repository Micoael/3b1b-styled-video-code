...
class Scene_5():
    def construct(_):
        ...
        vg = VGroup(
            CodeLine("b.next_to(a,~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#对齐对象"),
            CodeLine("~~~~UP/DOWN/LEFT/RIGHT,~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#对齐方向"),
            CodeLine("~~~~aligned_edge=UP/DOWN/LEFT/RIGHT/ORIGIN,~~~~~~~~~~~#对齐哪条边"),
            CodeLine("~~~~index_of_submobject_to_align=i,~~~~~~~~~~~~~~~~~~~#把A[i]和B对齐"),
            CodeLine("~~~~submobject_to_align=B[j],~~~~~~~~~~~~~~~~~~~~~~~~~#把A[i]和B[j]对齐"),
            CodeLine("~~~~submobject_to_align=B[j],~~~~~~~~~~~~~~~~~~~~~~~~~#把A[i]和B[j]对齐"),
            CodeLine(")"),
        )
        vg.arrange(DOWN)
